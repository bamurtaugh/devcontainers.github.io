...
1. **Header Background**: The `.bg-primary` class (used in the site header) will use a linear gradient from `gradient_start_color` to `gradient_end_color` at a fixed 135-degree angle (diagonal from top-left to bottom-right)
